...
gcc -std=c99 -fPIC -L./ example-reverse.o -levent_core -lgetdns -o example-reverse 
rm -rf *.o *.dylib
...
clang -std=c99 -fPIC -L./ example-reverse.o -levent_core -lgetdns -o example-reverse 
