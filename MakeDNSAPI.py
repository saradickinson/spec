...
DefinesArr.append([ 600, "GETDNS_CONTEXT_CODE_", "Context codes",
	...
	[ "MEMORY_ALLOCATOR", "Change related to <code>getdns_context_set_memory_allocator</code>" ],
	[ "MEMORY_DEALLOCATOR", "Change related to <code>getdns_context_set_memory_deallocator</code>" ],
	[ "MEMORY_REALLOCATOR", "Change related to <code>getdns_context_set_memory_reallocator</code>" ],
])
...
<code>iterations</code> (an int), <code>salt_length</code> (an int), <code>salt</code> (a bindata),
<code>hash_length</code> (an int), <code>next_hashed_owner_name</code> (a bindata), and
<code>type_bit_maps</code> (a bindata)</p>

<p class=define>NSEC3PARAM (51)</p>
<p class=descrip><code>hash_algorithm</code> (an int), <code>flags</code> (an int),
<code>iterations</code> (an int), <code>salt_length</code> (an int), and
...
<p class=descrip><code>hit_length</code> (an int), <code>pk_algorithm</code> (an int),
<code>pk_length</code> (an int), <code>hit</code> (a bindata), <code>public_key</code>
(a bindata), and <code>rendezvous_servers</code> (a bindata)</p>
...
<p class=descrip><code>preference</code> (an int), <code>locator32_msbs</code> (a bindata),
